 ...
 */
package com.binish.videoeditor.grafika
...
import com.binish.videoeditor.MainActivity
import java.io.File
...
class MoviePlayer(
    ...
    fun play() {
        ...
        try {
            ...
            extractor.setDataSource(context, mSourceFile, null)
